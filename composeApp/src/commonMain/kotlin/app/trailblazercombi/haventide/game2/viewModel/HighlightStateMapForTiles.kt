 ...
 *
 * This is the Interface component, unifying [TileHighlightStateMap] and [MutableTileHighlightStateMap].
 */
interface HighlightStateMapForTiles {
    ...
    fun toTileStateMap(): TileHighlightStateMap
    fun toMutableTileStateMap(): MutableTileHighlightStateMap
