 ...
 * Then, it gets turned into a new [TileStateMap] (immutable).
 */
class MutableTileStateMap : StateMapForTiles {
    ...
    override fun toMutableTileStateMap(): MutableTileStateMap = MutableTileStateMap(data)
