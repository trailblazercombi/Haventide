...
import app.trailblazercombi.haventide.resources.PlaceholderPlayerConfiguration
...
object Global {
    ...
    val localPlayer: PlayerProfile = PlaceholderPlayerConfiguration.PLAYER_ONE.toProfile() // FIXME Dynamic allocation later
